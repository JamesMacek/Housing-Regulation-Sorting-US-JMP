...
This file runs mostly R code with some Stata called directly from R. It uses proprietary data, so this replication file cannot be currently run publicly. Providing public-safe and compressed data is a work in progress.
