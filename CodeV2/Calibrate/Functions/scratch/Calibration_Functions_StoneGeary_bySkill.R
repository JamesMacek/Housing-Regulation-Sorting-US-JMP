...
Calibrate_prices <- function(Master_data, demandParameters, #Pass data frame, housing demand parameters.
  ...
  #min_hReq <- demandParameters[2] #Minimum housing consumption requirement
    ...
    #skillVector <-  bySkillVector #
    #skillName <- c("College_", "NoCollege_") #name of wages
  
  
  #CASE 1: PARTIAL REGULATION___________________________________________________  
  ...
  #CASE 2: IF EITHER 100% of the neighborhood is regulated or not:______________________________________________________
...
#Start excess demand function here -- takes all objects from environment ran within Calibrate_prices
