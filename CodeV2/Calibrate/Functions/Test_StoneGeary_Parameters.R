...
Master_data_sample <- Master[sample(nrow(Master), 1000), ]

get_spendshare_error(Master_data = Master_data_sample, 
                     demandParameters = c(0.08, 5000)) #THIS WORKS WELL!


#doing the same for Cobb-Douglas