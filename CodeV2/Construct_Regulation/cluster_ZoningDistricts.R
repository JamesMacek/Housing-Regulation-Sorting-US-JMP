...
for (municipalitydef in municipality_definition_grid) {
for (desired_alpha in alpha_grid) { #start loop over alphas
...
if (file.exists(paste0("DataV2/CoreLogic/output/", filename_to_output)) == FALSE) {
...
}#End loop over alpha grid  
}#End loop over municipality definition
