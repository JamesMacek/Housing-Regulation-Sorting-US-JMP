...
US_BLOCK$SuperStar[US_BLOCK$CBSA_med_house_value > as.numeric(quantile_CBSA_houseval["75.0%"]) &
                     US_BLOCK$City_housing_density > as.numeric(quantile_CBSA_dens["75.0%"])] <- "Yes" #superstar dummy
...
#Aggregate table:
vtable::st(US_BLOCK[,!names(US_BLOCK) == "SuperStar city"],
           out = "latex",
           file = "DataV2/US_Data/Output/Facts_summarystats_aggregate.tex",
