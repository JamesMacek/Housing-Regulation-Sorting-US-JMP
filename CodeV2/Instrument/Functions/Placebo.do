...
*__LOCALS___
******************************************************
*ESTIMATES BY INCOME TYPE FROM FULLIV_CLUSTER_MSA.do (yields same estimates as bartlett kernel)
...
*REGRESS: partialled historical amenities on log_Average_Income
	...
	outreg2 using "DataV2/US_Data/Instrument/Placebo_Baseline", `replace' tex(pretty) label nocon dec(4) nor2 ///
...
forval i = 1/7 {
	...
	*_________________________________________________________
	...
	outreg2 using "DataV2/US_Data/Instrument/Placebo_Robust", `replace' tex(pretty) label nocon dec(4) nor2 ///
