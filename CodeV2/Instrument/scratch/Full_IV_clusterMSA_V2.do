...
*Slopes from construct_Slopes_at_buffers.R
use "DataV2/US_Data/Instrument/Instrument_constructed_buffers.dta", clear
...
*CENSORING LARGE BLOCK GROUPS WHERE DONUT EXPOSURE MIGHT BE MINIMAL
*changing ALAND into square kilometers
