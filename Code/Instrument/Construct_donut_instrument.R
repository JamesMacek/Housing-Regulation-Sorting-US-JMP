...
INCLUSION_BUFFER <- c(1000, 1000, 1200, 1500) #vector of buffers you want to try
...
#Load data
US_BLOCK <- st_read("Data/US_Data/Instrument/Slope_Extracted.shp") 
...
write_dta(US_BLOCK_APPENDED, "Data/US_Data/Instrument/Instrument_constructed.dta")
